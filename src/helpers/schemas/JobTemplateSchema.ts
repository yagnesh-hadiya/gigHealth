...
export const JobTemplateSchema = yup.object({
  title: yup
    .string()
  ...
  deptUnit: yup
    ...
    // .typeError("Department Unit is required and it should be of type string")
    .min(1, "Department Unit must be greater than or equal to 1")
