...
import { getOnboardingAppliedJobHistory } from "../../../services/TalentOnboarding";
...
const TalentAppliedJobHistoryModal = ({
  slotId,
  jobId,
  jobApplicationId,
  history = false,
  ...
  const fetch = async () => {
    setLoading("loading");
    try {
      const res = await getOnboardingAppliedJobHistory(jobId, jobApplicationId);
...
export default TalentAppliedJobHistoryModal;
