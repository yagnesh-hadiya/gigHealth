...
import { Document, SuggestedDocumentList } from "../../../types/TalentJobs";
import { capitalize, showToast } from "../../../helpers";
import Loader from "../../../components/custom/CustomSpinner";
import { applyTalentSuggestedProfessionalDocument } from "../../../services/TalentOnboarding";
import { TalentSuggestedDocsType } from "../../../types/TalentOnboardingTypes";

const TalentSuggestedDocs = ({
  docId,
  docCount,
  jobId,
  jobApplicationId,
...
TalentSuggestedDocsType) => {
  ...
  const handleApplyDocument = async () => {
    try {
      setLoading("loading");
      if (currentDocument) {
        const res = await applyTalentSuggestedProfessionalDocument(
          jobId,
          jobApplicationId,
          complianceId,
...
export default TalentSuggestedDocs;
