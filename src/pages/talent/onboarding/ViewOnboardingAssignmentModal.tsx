...
import { getOnboardingAssignmentDetails } from "../../../services/TalentOnboarding";

interface ViewOnboardingAssignmentModaProps {
  jobId: number;
...
const ViewOnboardingAssignmentModal = ({
  isOpen,
  toggle,
  jobId,
  jobApplicationId,
  jobAssignmentId,
}: ViewOnboardingAssignmentModaProps) => {
    ...
    const fetchData = async () => {
      try {
        const [detailsResponse] = await Promise.allSettled([
          getOnboardingAssignmentDetails(
            jobId,
            jobApplicationId,
            jobAssignmentId
          ),
  ...
  return (
    <Modal
      ...
      onClosed={toggle}
    >
      <ModalHeader toggle={toggle}>View Onboarding Details</ModalHeader>
      <ModalBody
...
export default ViewOnboardingAssignmentModal;
