...
import { AdditionalEmergencyContactModalType } from "../../../types/ProfessionalDocumentType";
import {
...
const AdditionalEmergencyContactModal = ({
  isOpen,
  toggle,
  state,
  dispatch,
  setFetch,
}: AdditionalEmergencyContactModalType) => {
  ...
  const onSubmit = async (data: CreateEmergencyContactType) => {
    ...
    try {
      ...
      setLoading("loading");
      const response = await createAdminEmergencyContact(
        professionalId,
...
export default AdditionalEmergencyContactModal;
