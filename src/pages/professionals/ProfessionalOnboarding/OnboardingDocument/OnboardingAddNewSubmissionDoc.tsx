...
const OnboardingAddNewSubmissionDoc = ({
  isOpen,
  toggle,
  jobId,
  jobApplicationId,
  ...
  const submit = async () => {
    ...
    try {
      ...
      const res = await ProfessionalOnboardingServices.addNewSubmissionDocument(
        {
          jobId: jobId,
...
export default OnboardingAddNewSubmissionDoc;
