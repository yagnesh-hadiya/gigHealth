...
import OnboardingAddNewDoc from "./OnboardingAddNewDoc";
...
type ProfessionalOnboardingDocumentsProps = {
  facilityId: number;
  jobId: number;
...
const ProfessionalOnboardingDocuments = ({
  facilityId,
  jobId,
  professionalId,
  jobApplicationId,
  fetchOnboardingDocuments,
}: ProfessionalOnboardingDocumentsProps) => {
  ...
  const fetch = useCallback(async () => {
    ...
    try {
      const response =
        await ProfessionalOnboardingServices.getOnboardingDocuments({
          jobId,
          facilityId,
          professionalId,
          jobApplicationId,
...
export default ProfessionalOnboardingDocuments;
