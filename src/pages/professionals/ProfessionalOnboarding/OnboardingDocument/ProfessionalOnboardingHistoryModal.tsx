...
type ProfessionalOnboardingHistoryModalProps = {
  jobId: number;
...
const ProfessionalOnboardingHistoryModal = ({
  jobId,
  professionalId,
  facilityId,
  jobApplicationId,
  slotId,
}: ProfessionalOnboardingHistoryModalProps) => {
  console.log(
    "jobId",
    jobId,
    professionalId,
  ...
  const fetch = async () => {
    setLoading("loading");
    try {
      const res = await ProfessionalOnboardingServices.fetchHistory({
...
export default ProfessionalOnboardingHistoryModal;
