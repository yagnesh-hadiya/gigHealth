...
const ProfessionalAssignmentDetailsModal = ({
  isOpen,
  toggle,
  facilityId,
  jobId,
  ...
  useEffect(() => {
    if (data) {
      ...
      setSpecialityId(data?.JobProfession.Id);
  ...
  const onSubmit = async (data: OfferFormType) => {
    ...
    try {
      ...
      const res = await ProfessionalOnboardingServices.editAssignment(
...
export default ProfessionalAssignmentDetailsModal;
