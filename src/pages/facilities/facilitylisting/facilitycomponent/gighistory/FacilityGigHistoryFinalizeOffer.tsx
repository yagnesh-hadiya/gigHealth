...
import { FacilityGigHistoryJobAssignment } from "../../../../../types/FacilityGigHistoryType";
...
type FacilityGigHistoryFinalizeOfferProps = {
  isOpen: boolean;
  toggle: () => void;
  facilityId: number;
  jobId: number;
  ...
  slot: FacilityGigHistoryJobAssignment;
...
const FacilityGigHistoryFinalizeOffer = ({
  isOpen,
  toggle,
  professionalId,
  jobApplicationId,
  ...
  facilityId,
  jobId,
}: FacilityGigHistoryFinalizeOfferProps) => {
  ...
  const place = async () => {
    setLoading(true);
    try {
      const res = await FacilityGigHistoryServices.placeJobAssignment({
        facilityId: Number(facilityId),
        jobId: Number(jobId),
        professionalId: professionalId,
        jobApplicationId: jobApplicationId,
            ...
            <div>
              <div className="View-profile-section">
                ...
                <div className="application-wrapper d-flex align-items-center select-view">
                  ...
                  <span
                    style={{
                      color: getStatusColor(slot.JobApplicationStatus.Status),
                      borderColor: getStatusColor(
                        slot.JobApplicationStatus.Status
                      ),
                      marginLeft: "10px",
                      border: "1px solid",
            ...
            <Form>
              ...
              <Row>
                ...
                <Col xxl="4" xl="4" lg="6" md="6" className="col-group">
                  ...
                  <CustomInput disabled value={slot.ReqId?.toUpperCase()} />
                </Col>
              </Row>
...
export default FacilityGigHistoryFinalizeOffer;
