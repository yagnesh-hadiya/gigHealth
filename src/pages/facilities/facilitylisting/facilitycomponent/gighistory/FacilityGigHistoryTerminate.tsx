...
type FacilityGigHistoryTerminateProps = {
  facilityId: number;
  jobId: number;
...
const FacilityGigHistoryTerminate = ({
  isOpen,
  toggle,
  facilityId,
  jobId,
  ...
  professionalId,
  fetchRoster,
}: FacilityGigHistoryTerminateProps) => {
  ...
  const termination = async () => {
    ...
    try {
      const res = await RosterServices.terminateJobAssignment({
        facilityId,
        jobId,
        professionalId,
        jobApplicationId,
...
export default FacilityGigHistoryTerminate;
