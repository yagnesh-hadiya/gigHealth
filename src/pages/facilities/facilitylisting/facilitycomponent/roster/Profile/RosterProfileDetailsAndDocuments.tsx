...
import ReadOnlyRosterCertificateCard from "./ReadOnlyRosterCertificateCard";
import ReadOnlyRosterLicensesCard from "./ReadOnlyRosterLicensesCard";
...
type RosterProfileDetailsAndDocumentsTypes = {
  professionalId: number;
  jobId: number;
  facilityId: number;
};

const RosterProfileDetailsAndDocuments = ({
  professionalId,
  jobId,
  facilityId,
}: RosterProfileDetailsAndDocumentsTypes) => {
  ...
  const fetchDocuments = useCallback(async () => {
    setLoading("loading");
    try {
      const res = await RosterServices.fetchProfessionalDocuments({
        facilityId,
        jobId,
        professionalId,
        size,
  ...
  useEffect(() => {
    ...
    const apiCalls = [
      ...
      RosterServices.fetchProfessionalReferences,
      RosterServices.fetchProfessionalEducation,
      RosterServices.fetchProfessionalLicenses,
      RosterServices.fetchProfessionalCertifications,
    ];
...
export default RosterProfileDetailsAndDocuments;
