...
import { terminateJobAssignment } from "../../../../services/OpeningServices";
...
const Terminate = ({
  ...
  const termination = async () => {
    ...
    try {
      const res = await terminateJobAssignment({
        facilityId,
        jobId,
        professionalId,
        jobApplicationId,
          ...
          <Form>
            <Row>
              <Col md="12" className="col-group">
                <Label>Select Termination By <span className="asterisk">*</span></Label>
                <CustomSelect
                  id="termination"
            ...
            <Row>
              <Col md="12" className="col-group mb-0">
                <Label>Notes <span className="asterisk">*</span></Label>
                <CustomTextArea
                  value={notes}
